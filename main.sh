...
echo -e "\e[95m ___           _        _ _       _   _"
echo -e "\e[95m|_ _|_ __  ___| |_ __ _| | | __ _| |_(_) ___ "
echo -e "\e[95m | || '_ \/ __| __/ _\` | | |/ _\` | __| |/ _ \ "
echo -e "\e[95m | || | | \__ \ || (_| | | | (_| | |_| |  __/"
echo -e "\e[95m|___|_| |_|___/\__\__,_|_|_|\__,_|\__|_|\___|"
echo -e "\n"
echo -e "\e[95m** Installatieprogramma voor minilaptops op Siriusscholen"
echo -e "\e[95m** Geschreven door Stan Verschuuren"
echo -e "\e[95m** Dit werk valt onder het Creative Commons Attribution-NonCommercial-ShareAlike licensie\e[0m"
